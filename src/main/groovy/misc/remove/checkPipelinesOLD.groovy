...
// note: switched from json objects, to wrapper IndexPipelines upval object (which should provide js stage parsing)
...
def jsStages = indexPipelines.javascriptStages
jsStages.each {String key, List< Javascript> jsWrapper ->
    log.info "JS Stage (${key}): ${jsWrapper.lines.size()} lines"
}
